...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-orange-500/20 rounded-full mix-blend-screen filter blur-3xl animate-blob"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-violet-500/20 rounded-full mix-blend-screen filter blur-3xl animate-blob animation-delay-2000"></div>
      <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-purple-500/10 rounded-full mix-blend-screen filter blur-3xl animate-blob animation-delay-4000"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-slate-300">Manage your documents efficiently</p>
        </div>
        ...
        >
          ...
          <p className="text-slate-400 mb-6">Sign in to continue to DocVault</p>
